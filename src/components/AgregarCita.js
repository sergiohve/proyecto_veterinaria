...
class AgregarCita extends Component {
    ...
    nombreDuenoMascotaRef = React.createRef();
    ...
    crearNuevaCita = (e) => {
        ...
        const nuevaCita = {
            ...
            nombreDueno: this.nombreDuenoMascotaRef.current.value,
                ...
                <div className="card-body">
                    ...
                    <form onSubmit={this.crearNuevaCita}>
                        ...
                        <div className="form-group row">
                            ...
                            <div className="col-sm-8 col-lg-10">
                                <input ref={this.nombreDuenoMascotaRef} type="text" className="form-control"  placeholder="Nombre Dueño de la Mascota" />
                            </div>
                        </div>
